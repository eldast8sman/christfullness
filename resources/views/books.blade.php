            ...
            <div class="row g-4">
                @foreach ($books as $book)
                    <div class="col-lg-4 col-md-6 wow fadeInUp rounded" data-wow-delay="0.1s">
                        ...
                        {{-- <img class="img-fluid" width="100%" height="auto" src="{{ $book->compressed_image }}" alt="{{ $book->title }}">
                        <div class="bg-light p-4">
                            <a class="d-block h5 lh-base mb-4" href="{{ env('APP_URL') }}/publications/books/{{ $book->slug }}">{{ $book->title }}</a>
