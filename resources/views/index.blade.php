        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                @if (!empty($first_slider))
                    <div class="carousel-item active" style="background-image: url({{ $first_slider->filename }}); background-size:cover; background-position: top right">
                        <img class="w-100" src="{{ $first_slider->filename }}" alt="Image" style="opacity: 0">
                ...
                @if (!empty($sliders))
                    @foreach ($sliders as $slider)
                        <div class="carousel-item" style="background-image: url({{ $slider->filename }}); background-size:cover; background-position: top right">
                            <img class="w-100" src="{{ $slider->filename }}" alt="Image" style="opacity: 0">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-start">
                                        <div class="col-lg-7">
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img position-relative overflow-hidden p-5 pe-0">
                        <img class="img-fluid w-100" src="{{ $welcome->filename }}">
                    </div>
                </div>
    ...
    <div class="container-fluid bg-light bg-icon my-5 py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6 mb-3">Spirit Word Devotionals</h1>
            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                        <h1 class="display-5 mb-3">Messages</h1>
                        <p>Tempor ut dolore lorem kasd vero ipsum sit eirmod sit. Ipsum diam justo sed rebum vero dolor duo.</p>
                    </div>
                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item">
                                    <div class="position-relative bg-light overflow-hidden">
                                        <img class="img-fluid w-100" src="{{ $message->compressed_image }}" alt="">
                                        <div class="bg-secondary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">New</div>
                                    </div>
                                    <div class="text-center p-4">
                                        <a class="d-block h5 mb-2" href="">{{ $message->title }}</a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-md-7 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="display-5 text-white mb-3">{{ $banner->title }}</h1>
                    <p class="text-white mb-0">{{ $banner->content }}</p>
                </div>
                <div class="col-md-5 text-md-end wow fadeIn" data-wow-delay="0.5s">
                    <a class="btn btn-lg btn-secondary rounded-pill py-3 px-5" href="{{ $banner->link }}">{{ $banner->call_to_action }}</a>
                </div>
            </div>
        </div>
    </div>
                ...
                @foreach ($quotes as $quote)
                    <div class="testimonial-item position-relative bg-white p-5 mt-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="flex-shrink-0 rounded-circle" src="{{ $quote->compressed }}" alt="">
                            <div class="ms-3">
                                <h5 class="mb-1">{{ $quote->author }}</h5>
                                <span>{{ $quote->author_title }}</span>
                            </div>
                        </div>
                    </div>    
                @endforeach
